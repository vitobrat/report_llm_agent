...
from src.infrastructure.graphs.generate_chapters.schema import GenerateChaptersState, ChapterWithContent, Chapter
...
class PostInterviewingRequest(BaseModel):
    ...
    chapter: ChapterWithContent  # Report chapter
...
class PostResearchRequest(BaseModel):
    topic: str  # topic of interviewing
    chapters: List[ChapterWithContent]
